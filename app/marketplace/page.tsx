  ...
  return (
    <>
      <PageHero eyebrow="Island marketplace" title="Buy, sell, pass it on." description="Useful finds, leaving-island sales and local deals from people across Santorini.">
        <Link href="/submit-request?package=basic-listing" className="mt-7 inline-flex items-center gap-2 rounded-xl bg-sunset px-5 py-3 text-sm font-bold text-white hover:bg-orange-600"><Plus size={17} /> Submit a listing request</Link>
      </PageHero>
